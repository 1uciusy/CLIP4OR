...
class RoadSegModel(BaseModel):
    ...
    def initialize(self, opt, dataset):
        ...
        # mix_transformer
        self.netRoadSeg = transformer.define_RoadSeg(opt, dataset.num_labels, use_sne=opt.use_sne,
        ...
        if self.isTrain:
            ...
            self.optimizers = []
            self.optimizer_RoadSeg = torch.optim.SGD(self.netRoadSeg.parameters(), lr=opt.lr, momentum=opt.momentum,

...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--useWidth', type=int, default=1280//2, help='scale images to this width 640')
        parser.add_argument('--useHeight', type=int, default=704//2, help='scale images to this height 352')
